...
/**
 * increments a stat count by custom value
 * @param  {String} stat        The stat key
 * @param  {Number} value Value to increase the stat by, defaults to 1
 * @param  {Array|Object} tags The tags associated with the metric (optional)
 */
exports.incrementBy = function(stat, value, tags) {
  if (arguments.length === 2) {
  ...
  statsd.incrementBy(PREFIX + stat, value, convertTagsIfRequired(tags));
};
...
/**
 * decrements a stat count by custom value
 * @param  {String} stat        The stat key
 * @param  {Number} value  Value to decrease the stat by, defaults to 1
 * @param  {Array|Object} tags  The tags associated with the metric (optional)
 */
exports.decrementBy = function(stat, value, tags) {
  if (arguments.length === 2) {
    if (_.isArray(value) || _.isObject(value)) {
      tags = value;
      value = 1;
  ...
  statsd.decrementBy(PREFIX + stat, value, convertTagsIfRequired(tags));
};
